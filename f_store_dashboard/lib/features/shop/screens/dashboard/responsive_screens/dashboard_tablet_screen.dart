  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          padding:
              const EdgeInsets.all(FSizes.defaultSpace), // Use default padding
          child: Obx(
            () {
              ...
              final double averageOrderValue = totalOrdersFromList > 0
                  ? totalSalesAmount / totalOrdersFromList
                  : 0.0;
              // Formatters
                    ...
                    children: [
                      ...
                      Expanded(
                        child: FDashboardCard(
                          ...
                          stats: 2, // Placeholder
                          title: 'Visitors',
                          subTitle: compactFormatter.format(controller
                              .customerController
                              .allItems
                              .length), // Placeholder
                        ),
