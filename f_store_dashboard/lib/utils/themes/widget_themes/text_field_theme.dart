...
class FTextFormFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    errorMaxLines: 3, prefixIconColor: FColors.darkGrey,
    suffixIconColor: FColors.darkGrey,
    //constraints: BoxConstraints.expand(height: FSizes.inputFieldHeight),
    ...
    errorMaxLines: 2, prefixIconColor: FColors.darkGrey,
    suffixIconColor: FColors.darkGrey,
    //constraints: BoxConstraints.expand(height: FSizes.inputFieldHeight),
    labelStyle: const TextStyle().copyWith(
      fontSize: FSizes.fontSizeMd,
    ...
    floatingLabelStyle: const TextStyle().copyWith(
      color: FColors.white.withOpacity(.8),
    ),
    border: const OutlineInputBorder().copyWith(
      borderRadius: BorderRadius.circular(FSizes.inputFieldRadius),
      borderSide: const BorderSide(
