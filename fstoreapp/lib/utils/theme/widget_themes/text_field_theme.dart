...
class FTextFormFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    ...
    labelStyle: const TextStyle()
        .copyWith(fontSize: FSizes.fontSizeMd, color: FColors.black),
    hintStyle: const TextStyle()
        .copyWith(fontSize: FSizes.fontSizeSm, color: FColors.black),
  ...
  static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
    ...
    // constraints: const BoxConstraints.expand(height: FSizes.inputFieldHeight),
    labelStyle: const TextStyle()
        .copyWith(fontSize: FSizes.fontSizeMd, color: FColors.white),
    hintStyle: const TextStyle()
        .copyWith(fontSize: FSizes.fontSizeSm, color: FColors.white),
    floatingLabelStyle:
